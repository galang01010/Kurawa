...
clear;clear;clear
echo -e "${YELLOW}╔════════════════════════════════════════════════╗${NC}"
echo -e "  Script Auto Installer VPS ${YELLOW}(${NC}${green} Backenv3 Edition ${NC}${YELLOW})${NC}"
echo -e "  SABDO PALON STORE"
echo -e "  Auther : ${green}elvaretta-store ${NC}${YELLOW}(${NC}${green} t.me/budi_spielberg ${NC}${YELLOW})${NC}"
echo -e "  Recode By SABDO PALON STORE  ©  2024"
echo -e "  since 2023"
echo -e "${YELLOW}╚════════════════════════════════════════════════╝${NC}"
echo ""
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/galang01010/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/galang01010/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/galang01010/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/galang01010/kurawa/main/"
start=$(date +%s)
secs_to_human() {
...
TIMES="10"
CHATID="6665982160"
KEY="6805862376:AAHS94n9Suc7AB8laAKw_FuaSwxUGDHFHjo"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/galang01010/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/galang01010/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/budi_spielberg"},{"text":"Contack","url":"wa.me/6285173028866"}]]}'
...
wget "http://raw.githubusercontent.com/galang01010/kurawa/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
cd /bin
git clone https://github.com/elvaretta-store/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m           ----[ SABDO PALON STORE ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  telegam : sabdopalonstore \e[0m"
echo -e "\e[95;1m  admin 1 : 085161256106 \e[0m"
echo -e "\e[95;1m  admin 2 : 082313716106 \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
